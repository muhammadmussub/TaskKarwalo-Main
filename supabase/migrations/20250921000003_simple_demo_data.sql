-- Simple TaskKarwalo Demo Data - Fixed Version
-- This creates demo data without foreign key constraint issues

-- Insert demo profiles (these will work with the auth system)
...
SET
  stat_value = (
    SELECT COALESCE(SUM(final_price), 0) FROM public.bookings WHERE status = 'completed'
  )
